package com.tutorial.main.player;
...
import com.tutorial.main.entity.player.Player;
	...
	public void keyPressed(KeyEvent e) {
		...
		for(int i = 0; i < handler.object.size(); i++) {
			...
			if(tempObject.getId() == ID.Player) {
				Player tempObj = (Player) tempObject;
				if(key == KeyEvent.VK_W) { tempObject.setVelY(-tempObj.speed); keyDown[0]=true; }
				if(key == KeyEvent.VK_S) { tempObject.setVelY(tempObj.speed); keyDown[1]=true; }
				if(key == KeyEvent.VK_D) { tempObject.setVelX(tempObj.speed); keyDown[2]=true; }
				if(key == KeyEvent.VK_A) { tempObject.setVelX(-tempObj.speed); keyDown[3]=true; }
